      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        >
          <div className="lg:col-span-7">
            <span className="inline-flex items-center gap-2.5 rounded-full bg-turquoise-50 px-5 py-2.5 text-sm font-medium text-turquoise-700 mb-8 shadow-sm shadow-turquoise-100/50 ring-1 ring-turquoise-100">
        ...
        <div className="grid gap-6 lg:grid-cols-12 mb-6">
          ...
          >
            <div className="rounded-[2rem] bg-gradient-to-br from-turquoise-600 via-turquoise-700 to-turquoise-900 text-white p-10 shadow-xl shadow-turquoise-900/20 w-full flex flex-col justify-center relative overflow-hidden backdrop-blur-sm">
              {/* Decorative elements */}
          ...
          <motion.div
            ...
            variants={cardVariants}
          >
            <div className="rounded-[2rem] overflow-hidden shadow-xl shadow-turquoise-900/20 w-full relative">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <motion.div
            ...
            variants={cardVariants}
          >
            <div className="rounded-[2rem] bg-white/90 backdrop-blur-sm p-10 shadow-xl ring-1 ring-turquoise-100/80 w-full flex flex-col justify-between hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
              <div>
                <div className="w-14 h-14 rounded-2xl bg-turquoise-50 flex items-center justify-center mb-6 ring-1 ring-turquoise-100">
                  <svg
          ...
          <motion.div
            ...
            variants={cardVariants}
          >
            <div className="rounded-[2rem] overflow-hidden shadow-xl shadow-turquoise-900/20 w-full relative bg-gradient-to-br from-turquoise-600 via-turquoise-700 to-turquoise-900 p-10">
              <div className="absolute inset-0 bg-gradient-to-br from-turquoise-600/10 to-transparent mix-blend-overlay" />
              <div className="absolute top-0 right-0 w-40 h-40 bg-turquoise-400/20 rounded-full blur-3xl" />
              <div className="absolute bottom-0 left-0 w-40 h-40 bg-turquoise-500/10 rounded-full blur-3xl" />
              <div className="relative z-10">
                <div className="w-14 h-14 rounded-2xl bg-turquoise-400/20 flex items-center justify-center mb-6 ring-1 ring-turquoise-400/30">
                  <svg
                    className="w-7 h-7 text-turquoise-400"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
          ...
          <motion.div
            ...
            variants={cardVariants}
          >
            <div className="rounded-[2rem] p-10 bg-gradient-to-br from-turquoise-50 to-blue-50/50 text-stone-900 shadow-xl w-full flex flex-col justify-between hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 backdrop-blur-sm">
              <div>
                <div className="w-14 h-14 rounded-2xl bg-turquoise-50 flex items-center justify-center mb-6 ring-1 ring-turquoise-100">
                  <svg
                    className="w-7 h-7 text-turquoise-600"
